module.exports = (grunt) => {
    ...
    return {
        ...
        'prerender': {
            cmd: `npx ng run web-audio-meetup-may-2019:server:production && \
                npx angular-prerender \
                    --browser-target web-audio-meetup-may-2019:build \
                    --preserve-index-html \
                    --server-target web-audio-meetup-may-2019:server`
        },
        'preview': {
