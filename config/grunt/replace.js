        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    match: /[\s]*"\/web-audio-meetup-may-2019(\/scripts)?\/runtime\.[a-z0-9]+.js",/g,
                    replacement: ''
                }, {
                    match: /[\s]*"\/web-audio-meetup-may-2019(\/scripts)?\/runtime\.[a-z0-9]+.js":\s"[a-z0-9]+",/g,
                    replacement: ''
                }, {
                    // Replace the hash value inside of the hashTable for "/scripts/main.*.js" because it was modified before.
                    match: /"\/web-audio-meetup-may-2019(\/scripts\/main\.[a-z0-9]+.js)":\s"[a-z0-9]+"/g,
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (match, filename) => {
                        return `<script type="text/javascript">${ fs.readFileSync(`build/web-audio-meetup-may-2019/${ filename }`) }</script>`;
                    }
                } ]
            }
        },
