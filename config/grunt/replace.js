        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: () => grunt.file.expand({ cwd: 'build/web-audio-meetup-may-2019' }, 'assets/*.apple-touch-icon.png')[0]
                }, {
                    match: /assets\/favicon\.ico/g,
                    replacement: () => grunt.file.expand({ cwd: 'build/web-audio-meetup-may-2019' }, 'assets/*.favicon.ico')[0]
                }, {
