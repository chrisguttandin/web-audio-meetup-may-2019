        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    match: /"\/web-audio-meetup-may-2019\/index\.html":\s"[a-z0-9]+"/g,
                    replacement: () => {
                        return `"/web-audio-meetup-may-2019/index.html": "${ computeHashOfFile('build/web-audio-meetup-may-2019/index.html', 'sha1', 'hex') }"`;
                    }
                } ]
            }
        },
