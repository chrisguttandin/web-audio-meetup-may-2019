        ...
        'manifest': {
            ...
            options: {
                patterns: [ {
                    ...
                    replacement: (_, filename, extension) => grunt.file.expand({ cwd: 'build/web-audio-meetup-may-2019', ext: extension }, `assets/${ filename }.*`)[0]
                }, {
                    ...
                    match: /"\/web-audio-meetup-may-2019(?<filename>\/scripts\/(?:\d+|main|scripts)(?:-es(?:2015|5))?.[\da-z]+.js)":\s"[\da-z]+"/g,
                    ...
                    match: /"\/web-audio-meetup-may-2019(?<filename>\/styles\/styles\.[\da-z]*\.css)":\s"[\da-z]+"/g,
                    replacement: (_, filename) => {
                        return `"/web-audio-meetup-may-2019${ filename }": "${ computeHashOfFile(`build/web-audio-meetup-may-2019${ filename }`, 'sha1', 'hex') }"`;
                    }
                }, {
